...
class Naive(tf.keras.Model):
    ...
    def __init__(self, num_features):
        ...
        self.upsample_3 = tf.keras.layers.UpSampling2D(2, 'bilinear')
        ...
        self.upsample_2 = tf.keras.layers.UpSampling2D(2, 'bilinear')
        ...
        self.upsample_1 = tf.keras.layers.UpSampling2D(2, 'bilinear')
